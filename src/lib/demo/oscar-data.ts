...
export const DEMO_CATEGORIES: DemoCategory[] = [
  ...
  },
  {
    ...
    nominees: [
      ...
      { id: "bd-baker", name: "Sean Baker", subtitle: "Anora", isWinner: true },
  ...
  },
  {
    ...
    nominees: [
      ...
      { id: "ba-gascon", name: "Karla Sofía Gascón", subtitle: "Emilia Pérez", isWinner: false },
    ],
  },
  {
    id: "best-actor",
  ...
  },
  {
    ...
    nominees: [
      ...
      { id: "bsa-jones", name: "Felicity Jones", subtitle: "The Brutalist", isWinner: false },
  ...
  },
  {
    ...
    nominees: [
      ...
      { id: "bif-flow", name: "Flow", subtitle: "Latvia", isWinner: true },
    ],
  },
  {
  ...
  },
  {
    ...
    nominees: [
      ...
      { id: "bmh-nosferatu", name: "Nosferatu", isWinner: false },
      { id: "bmh-substance", name: "The Substance", isWinner: true },
...
export function getWinner(category: DemoCategory): DemoNominee {
  ...
  if (!winner) throw new Error(`No winner marked for category: ${category.id}`);
  return winner;
}
