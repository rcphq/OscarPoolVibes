            ...
            <div className="grid gap-1">
              {category.nominees.map((nominee) => (
                <NomineeButton
                  ...
                  disabledReason="Already selected as runner-up"
            ...
            <div className="grid gap-1">
              {category.nominees.map((nominee) => (
                <NomineeButton
                  ...
                  disabledReason="Already selected as first choice"
...
function NomineeButton({
  ...
  return (
    <button
      onClick={onClick}
      disabled={isDisabled}
      aria-label={isDisabled && disabledReason ? `${name} — ${disabledReason}` : undefined}
